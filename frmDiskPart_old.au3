Func CreateForm_frmDiskPart(ByRef $afrmNew)
	...
	$afrmNew[0][1] = GUICreate("Diskpart GUI 0.6 Beta", 408, 475);, (@DesktopWidth - 405)/2, (@DesktopHeight - 457)/2)

	GUICtrlCreateGroup("Disco actual:", 8, 8, 391, 94)
	$afrmNew[1][0] = "$icoDrive"
	$afrmNew[1][1] = GUICtrlCreateIcon ("shell32.dll", 50, 24, 32, 32, 32)
	$afrmNew[2][0] = "$lblDiskLabel"
	$afrmNew[2][1] = GUICtrlCreateLabel("", 90, 8, 250, 16, $SS_LEFTNOWORDWRAP);, $WS_EX_STATICEDGE)
					GUICtrlSetFont(-1, 8.5, 600)
	GUICtrlCreateLabel("Disco: ", 100, 30, 53, 21)
	$afrmNew[3][0] = "$lblDiskNo"
	$afrmNew[3][1] = GUICtrlCreateLabel("", 136, 30, 30, 21, $SS_LEFTNOWORDWRAP);, $WS_EX_STATICEDGE)
	$afrmNew[4][0] = "$lblDiskType"
	$afrmNew[4][1] = GUICtrlCreateLabel("Estado:", 198, 30, 100, 21, $SS_LEFTNOWORDWRAP)
	$afrmNew[5][0] = "$lblDiskSize"
	$afrmNew[5][1] = GUICtrlCreateLabel("Tamaño: ", 100, 51, 100, 21, $SS_LEFTNOWORDWRAP);, $WS_EX_STATICEDGE)
	$afrmNew[6][0] = "$lblDiskFree"
	$afrmNew[6][1] = GUICtrlCreateLabel("Espacio Libre: ", 198, 51, 130, 21, $SS_LEFTNOWORDWRAP)
	$afrmNew[7][0] = "$cmdDiskBrowse"
	$afrmNew[7][1] = GUICtrlCreateButton("Cambiar Disco", 16, 67, 80, 27)  ; v 0.4.0.2
	$afrmNew[24][0] = "$cmdDiskClean"  ;v: 0.4.1.4
	$afrmNew[24][1] = GUICtrlCreateButton("Borrar Disco", 198,67, 80,27) ;v: 0.4.1.4

	GUICtrlCreateLabel("Particiones encontradas:", 8, 110, 100, 13)   ;version: 0.4.1.0
	GUICtrlCreateGroup("", 8, 121, 391, 201)
	$afrmNew[8][0] = "$lvwPartitions"
	$afrmNew[8][1] = GUICtrlCreateListView("Particion|Tipo|Tamaño|Espacio Libre|Sist. Archivos", 16, 136, 375, 144, _
	...
	$afrmNew[9][0] = "$cmdAdd"
	$afrmNew[9][1] = GUICtrlCreateButton("&Añadir...", 16, 288, 75, 25, $WS_DISABLED)
	$afrmNew[10][0] = "$cmdDelete"
	$afrmNew[10][1] = GUICtrlCreateButton("&Borrar", 96, 288, 75, 25, $WS_DISABLED)
	$afrmNew[11][0] = "$cmdEdit"
	$afrmNew[11][1] = GUICtrlCreateButton("&Editar...", 176, 288, 75, 25, $WS_DISABLED)
	$afrmNew[12][0] = "$cmdRefresh"
	$afrmNew[12][1] = GUICtrlCreateButton("Actualiza&r", 256, 288, 75, 25)

	GUICtrlCreateLabel("Datos de Particion:", 8, 330, 100, 13)
	GUICtrlCreateGroup("", 8, 341, 391, 101)

	GUICtrlCreateLabel("Volumen #:", 16, 355, 60, 13);, -1, $WS_EX_STATICEDGE)
	$afrmNew[13][0] = "$lblVolNo"
	$afrmNew[13][1] = GUICtrlCreateLabel("", 77, 355, 65, 13, $SS_LEFTNOWORDWRAP);, $WS_EX_STATICEDGE)
	GUICtrlCreateLabel("Offset:", 16, 379, 60, 13);, -1, $WS_EX_STATICEDGE)
	$afrmNew[14][0] = "$lblOffset"
	$afrmNew[14][1] = GUICtrlCreateLabel("", 77, 379, 65, 13, $SS_LEFTNOWORDWRAP);, $WS_EX_STATICEDGE)
	GUICtrlCreateLabel("Oculto:", 143, 355, 45, 13);, -1, $WS_EX_STATICEDGE)
	$afrmNew[15][0] = "$lblHidden"
	$afrmNew[15][1] = GUICtrlCreateLabel("", 189, 355, 65, 13, $SS_LEFTNOWORDWRAP);, $WS_EX_STATICEDGE)
	GUICtrlCreateLabel("Activo:", 143, 379, 45, 13);, -1, $WS_EX_STATICEDGE)
	$afrmNew[16][0] = "$lblActive"
	$afrmNew[16][1] = GUICtrlCreateLabel("", 189, 379, 65, 13, $SS_LEFTNOWORDWRAP);, $WS_EX_STATICEDGE)
	GUICtrlCreateLabel("Estado:", 256, 355, 40, 13);, -1, $WS_EX_STATICEDGE)
	$afrmNew[17][0] = "$lblStatus"
	$afrmNew[17][1] = GUICtrlCreateLabel("", 297, 355, 85, 13, $SS_LEFTNOWORDWRAP);, $WS_EX_STATICEDGE)
	GUICtrlCreateLabel("Info:", 256, 379, 40, 13);, -1, $WS_EX_STATICEDGE)
	$afrmNew[18][0] = "$lblInfo"
	$afrmNew[18][1] = GUICtrlCreateLabel("", 297, 379, 85, 13, $SS_LEFTNOWORDWRAP);, $WS_EX_STATICEDGE)

	$afrmNew[19][0] = "$cmdFormat"
	$afrmNew[19][1] = GUICtrlCreateButton("&Formatear...", 16, 408, 75, 25, $WS_DISABLED)
	$afrmNew[20][0] = "$cmdCheck"
	$afrmNew[20][1] = GUICtrlCreateButton("&Check...", 96, 408, 75, 25, $WS_DISABLED)
	$afrmNew[21][0] = "$cmdDefrag"
	$afrmNew[21][1] = GUICtrlCreateButton("Boot...", 176, 408, 75, 25, $WS_DISABLED)
	$afrmNew[22][0] = "$cmdProperties"
	$afrmNew[22][1] = GUICtrlCreateButton("&Propiedades...", 256, 408, 75, 25, $WS_DISABLED)
	$afrmNew[23][0] = "$stbStatus"
	$afrmNew[23][1] = GUICtrlCreateLabel("", 4, 453, 400, 18, -1, $WS_EX_STATICEDGE)
EndFunc
